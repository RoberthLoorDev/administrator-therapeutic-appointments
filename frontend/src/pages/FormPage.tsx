        ...
        <div className="content-container">
            ...
            <form className="form-create-appointment">
                <div className="label-input">
                    ...
                    <input required={true} className="input-text-form-style" type="text" name="names" value={formData.names} onChange={handleInputChange} />
                </div>

                <div className="label-input">
                    <label className="label-form">Apellidos:</label>
                    <input className="input-text-form-style" type="text" name="lastnames" value={formData.lastnames} onChange={handleInputChange} />
                </div>

                <div className="label-input">
                    <label className="label-form">Edad:</label>
                    <input className="input-text-form-style input-number-form-style" type="number" name="age" value={formData.age} onChange={handleInputChange} />
                </div>

                <div className="label-input">
                    <label className="label-form">Cedula:</label>
                    <input className="input-text-form-style" type="text" name="identification" value={formData.identification} onChange={handleInputChange} />
                </div>

                <div className="label-input">
                    <label className="label-form">Correo electrónico:</label>
                    <input className="input-text-form-style" type="text" name="email" value={formData.email} onChange={handleInputChange} />
                </div>
                ...
                <div className="label-input">
                    ...
                    <input className="input-text-form-style" type="text" name="typeTherapy" value={formData.typeTherapy} onChange={handleInputChange} />
                </div>

                <div className="label-input">
                    <label className="label-form">Forma de pago esperada:</label>

                    <select className="way-to-pay" name="expectedPaymentMethod" value={formData.expectedPaymentMethod} onChange={handleInputChange}>
